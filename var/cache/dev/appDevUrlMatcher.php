...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/home')) {
            // su_account_homepage
            if ($pathinfo === '/home') {
                return array (  '_controller' => 'SU\\AccountBundle\\Controller\\AccountController::homeAction',  '_route' => 'su_account_homepage',);
            }

            if (0 === strpos($pathinfo, '/home/m')) {
                // su_account_mobile_immediate
                if ($pathinfo === '/home/mimmediate') {
        ...
        // su_user_send_registration
        if ($pathinfo === '/sendRegistration') {
            return array (  '_controller' => 'SU\\UserBundle\\Controller\\UserController::sendRegistrationAction',  '_route' => 'su_user_send_registration',);
        }

        // su_user_param
        if ($pathinfo === '/user/param') {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'SU\\MainBundle\\Controller\\MainController::indexAction',  '_route' => 'su_main_homepage',);
        }
